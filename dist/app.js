...
var Caml_io                  = __webpack_require__(40);
var Caml_obj                 = __webpack_require__(3);
var Caml_sys                 = __webpack_require__(23);
var Caml_format              = __webpack_require__(13);
var Caml_string              = __webpack_require__(6);
var Caml_exceptions          = __webpack_require__(12);
var Caml_missing_polyfill    = __webpack_require__(22);
var Caml_builtin_exceptions  = __webpack_require__(0);
var CamlinternalFormatBasics = __webpack_require__(42);
...
var Caml_int64              = __webpack_require__(17);
...
var Curry                   = __webpack_require__(1);
var Js_exn                  = __webpack_require__(46);
var Caml_array              = __webpack_require__(11);
var Caml_exceptions         = __webpack_require__(12);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var List        = __webpack_require__(9);
var Bytes       = __webpack_require__(39);
var Caml_int32  = __webpack_require__(14);
var Caml_string = __webpack_require__(6);
...
var SequenceInput   = __webpack_require__(37);
var SequenceDisplay = __webpack_require__(36);
...
function make($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  ...
  var maxRetries = $staropt$star$2 ? $staropt$star$2[0] : 3;
  var newrecord = component.slice();
  newrecord[/* render */9] = (function (self) {
      var match = self[/* state */2][/* gameState */0];
      var tmp;
      switch (match) {
        case 0 : 
            tmp = React.createElement("button", {
                ...
                }, self[/* state */2][/* transitionMessage */4]);
            break;
        case 1 : 
            tmp = React.createElement("button", {
                  onClick: Curry._1(self[/* reduce */1], (function () {
            ...
            break;
        case 2 : 
            tmp = ReasonReact.element(/* None */0, /* None */0, SequenceDisplay.make(self[/* state */2][/* seq */2], /* Some */[500], Curry._1(self[/* reduce */1], (function () {
        ...
        case 3 : 
            ...
            break;
        case 4 : 
            tmp = ReasonReact.element(/* None */0, /* None */0, SequenceInput.make(numKeys, self[/* state */2][/* seq */2], Curry._1(self[/* reduce */1], (function () {
                            return /* RoundComplete */4;
                          })), Curry._1(self[/* reduce */1], (function () {
                            return /* IncorrectGuess */5;
                          })), /* array */[]));
            break;
        
      }
      return React.createElement("figure", undefined, tmp);
    });
  ...
  newrecord[/* reducer */12] = (function (action, state) {
      switch (action) {
        case 0 : 
            var round = nextRound(state[/* round */1], maxRounds);
            return /* Update */Block.__(0, [/* record */[
                        /* gameState : Ready */1,
                        /* round */round,
                        /* seq */growSeq(state[/* seq */2], state[/* round */1], numKeys, maxRounds),
                        /* restarts */state[/* restarts */3],
                        /* transitionMessage */"Time to go! Start round " + Pervasives.string_of_int(round)
                      ]]);
        case 1 : 
            return /* Update */Block.__(0, [/* record */[
                        ...
                        /* seq */state[/* seq */2],
                        /* restarts */state[/* restarts */3],
                        /* transitionMessage */state[/* transitionMessage */4]
                      ]]);
        case 2 : 
            return /* Update */Block.__(0, [/* record */[
        ...
        case 4 : 
            return /* Update */Block.__(0, [/* record */[
                        ...
                        /* seq */state[/* seq */2],
                        /* restarts */state[/* restarts */3],
                        /* transitionMessage */"Round " + (Pervasives.string_of_int(state[/* round */1]) + " complete! Ready to play again?")
                      ]]);
        case 5 : 
            var x = state[/* restarts */3];
            if (x !== 0) {
              return /* Update */Block.__(0, [/* record */[
                          /* gameState : Ready */1,
                          /* round */state[/* round */1],
                          /* seq */state[/* seq */2],
                          /* restarts */x - 1 | 0,
                          /* transitionMessage */"Oops! Only " + (Pervasives.string_of_int(x - 1 | 0) + " tries left! Lets watch the sequence again!")
                        ]]);
            } else {
              return /* Update */Block.__(0, [/* record */[
                          /* gameState : Waiting */0,
...
function make(displaySeq, $staropt$star, displayEndNotifier, _) {
  ...
  newrecord[/* willUnmount */6] = (function (self) {
      clearInterval(extractId(self[/* state */2][/* timerId */1][0]));
      return /* () */0;
    });
  newrecord[/* render */9] = (function (param) {
      return React.createElement("p", undefined, Helpers.intListToString(param[/* state */2][/* displaySeq */0]));
    });
  newrecord[/* initialState */10] = (function () {
      return /* record */[
...
var component = ReasonReact.reducerComponent("SequenceInput");

function make(keys, checkSeq, roundCompleteNotifier, gameOverNotifier, _) {
  var newrecord = component.slice();
  newrecord[/* render */9] = (function (self) {
      return React.createElement("figure", undefined, $$Array.of_list(List.map((function (i) {
                            return React.createElement("button", {
                                        key: Pervasives.string_of_int(i),
                                        value: Pervasives.string_of_int(i),
                                        onClick: Curry._1(self[/* reduce */1], (function () {
                                                return /* Check */[i];
                                              }))
  ...
  newrecord[/* initialState */10] = (function () {
      return /* record */[
              /* checkState : Guessing */0,
              /* currentCheckSeq */checkSeq
            ];
    });
  newrecord[/* reducer */12] = (function (action, state) {
      var i = action[0];
      var match = state[/* currentCheckSeq */1];
      if (match) {
        var xs = match[1];
        var x = match[0];
        var exit = 0;
        if (xs) {
          ...
          return /* UpdateWithSideEffects */Block.__(3, [
                    /* record */[
                      /* checkState : Complete */1,
                      /* currentCheckSeq : [] */0
                    ],
                    roundCompleteNotifier
                  ]);
        } else {
          exit = 1;
        }
...
var Simon       = __webpack_require__(34);
var ReactDOMRe  = __webpack_require__(35);
var ReasonReact = __webpack_require__(10);

ReactDOMRe.renderToElementWithId(ReasonReact.element(/* None */0, /* None */0, Simon.make(/* Some */[20], /* Some */[4], /* None */0, /* array */[])), "root");
...
var $$Array                 = __webpack_require__(21);
var Curry                   = __webpack_require__(1);
var Int32                   = __webpack_require__(44);
var Int64                   = __webpack_require__(45);
var Digest                  = __webpack_require__(43);
var Caml_sys                = __webpack_require__(23);
var Nativeint               = __webpack_require__(47);
var Caml_array              = __webpack_require__(11);
var Caml_int64              = __webpack_require__(17);
var Pervasives              = __webpack_require__(4);
var Caml_string             = __webpack_require__(6);
...
*/
var aa=__webpack_require__(5),m=__webpack_require__(28),A=__webpack_require__(16),B=__webpack_require__(7),ca=__webpack_require__(27),da=__webpack_require__(31),ea=__webpack_require__(32),ha=__webpack_require__(29),ia=__webpack_require__(30),C=__webpack_require__(15);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(16),n=__webpack_require__(15),p=__webpack_require__(7);
